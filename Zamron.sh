...
echo "Welcome to Zamron PDF Generator. Just lead Zamron to the folder which contains the Archives, and let Zamron do the rest. Copyright 2017 Bhachchaj."
echo "Warning! The archives will be deleted after the generation of the pdf's." 
